...
# process_cols_seq <- HydroBOT::make_pal(c('dummy1',
#                                          'Adult', 'dummy2', 'Regeneration', 'Recruitment'),
#                                        "lisa::GeorgiaOKeeffe")

# process_cols_seq <- HydroBOT::make_pal(c('1', '2', '3',
#                                          'Adult', 'Regeneration', 'Recruitment'),
#                                        "RColorBrewer::Dark2")

process_cols_seq <- HydroBOT::make_pal(c('Adult','Regeneration', 'Recruitment'),
...
wetland_type_pal <- HydroBOT::make_pal(c( "All wetland types", 
                                          "Recorded wetland types",
                                          "Named wetland types"),
                                        "RColorBrewer::Set2")

wetland_type_pal_fill <- HydroBOT::make_pal(c( "All wetland types", 
                                          "Recorded wetland types",
                                          "Named wetland types"),
